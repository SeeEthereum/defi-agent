...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-30 flex md:hidden items-center justify-around border-t border-border/60 bg-background/95 backdrop-blur-xl px-2 pb-safe">
      {navItems.map((item) => {
